// ========================================================================
//  VisitorHub - Visitor Booking System
  ...
  const html = `
    <div class="p-5 border-b border-slate-800">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-white font-bold text-lg leading-tight">VisitorHub</h1>
              ...
              ${users.map(u => {
                ...
                return `
                  <tr>
                    ...
                    <td class="text-slate-600 text-xs">${formatDate(safeDate(u.createdAt))}</td>
                    <td>
